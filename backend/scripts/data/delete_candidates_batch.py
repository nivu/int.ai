#!/usr/bin/env python3
"""
Delete multiple candidates by email with proper cascading deletes.
"""
...
CANDIDATES_TO_DELETE = [
    ...
    "sriramtantri2005@gmail.com",
    "sriramsidhu2005@gmail.com",
    "team@nunnarilabs.com",
]
...
def main():
    ...
    print()
    print("=" * 60)
    print("BATCH DELETE CANDIDATES")
    print("=" * 60)
    print()
    print(f"Candidates to delete: {len(CANDIDATES_TO_DELETE)}")
    for email in CANDIDATES_TO_DELETE:
        print(f"  • {email}")
    print()
